...
void FaceAddVertexAction::Do() {
    ...
    vec_float3 v1 = model_->GetVertex(vid1);
    vec_float3 v2 = model_->GetVertex(vid2);
    vec_float3 v3 = model_->GetVertex(vid3);
    
    vec_float3 new_v = DragonflyUtils::TriAvg(v1, v2, v3);
