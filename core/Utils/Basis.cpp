...
void DragonflyUtils::RotateBasisOnX(Basis *b, float angle) {
    ...
    vec_float3 unitx = vec_make_float3(b->x.x / magx, b->x.y / magx, b->x.z / magx);
    float magy = Magnitude(b->y);
    vec_float3 unity = vec_make_float3(b->y.x / magy, b->y.y / magy, b->y.z / magy);
    float magz = Magnitude(b->z);
    vec_float3 unitz = vec_make_float3(b->z.x / magz, b->z.y / magz, b->z.z / magz);
    ...
    b->y = vec_make_float3(newY.x * magy, newY.y * magy, newY.z * magy);
    b->z = vec_make_float3(newZ.x * magz, newZ.y * magz, newZ.z * magz);
}
...
void DragonflyUtils::RotateBasisOnY(Basis *b, float angle) {
    ...
    b->x = vec_make_float3(newX.x * magx, newX.y * magx, newX.z * magx);
    b->z = vec_make_float3(newZ.x * magz, newZ.y * magz, newZ.z * magz);
}
...
vec_float3 DragonflyUtils::TranslatePointToStandard(Basis *b, vec_float3 point) {
    vec_float3 ret;
    // x component
    ret.x = point.x * b->x.x;
    ret.y = point.x * b->x.y;
...
vec_float3 DragonflyUtils::RotatePointToStandard(Basis *b, vec_float3 point) {
    float magx = Magnitude(b->x);
    vec_float3 unitx = vec_make_float3(b->x.x / magx, b->x.y / magx, b->x.z / magx);
    float magy = Magnitude(b->y);
    vec_float3 unity = vec_make_float3(b->y.x / magy, b->y.y / magy, b->y.z / magy);
...
vec_float3 DragonflyUtils::TranslatePointToBasis(Basis *b, vec_float3 point) {
    vec_float3 ret;
...
vec_float3 DragonflyUtils::RotatePointToBasis(Basis *b, vec_float3 point) {
    float magx = Magnitude(b->x);
    vec_float3 unitx = vec_make_float3(b->x.x / magx, b->x.y / magx, b->x.z / magx);
    float magy = Magnitude(b->y);
    vec_float3 unity = vec_make_float3(b->y.x / magy, b->y.y / magy, b->y.z / magy);
